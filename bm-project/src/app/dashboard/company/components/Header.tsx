...
export default function CompanyHeader({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-gradient-to-r from-secondary/10 via-white to-primary/10">
